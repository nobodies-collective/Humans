...
namespace Profiles.Infrastructure.Migrations
{
    ...
    [Migration("20260206130000_ApplyConsentImmutabilityTrigger")]
    partial class ApplyConsentImmutabilityTrigger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Profiles.Domain.Entities.ApplicationStateHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Profiles.Domain.Entities.GoogleResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Profiles.Domain.Entities.RoleAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Profiles.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Profiles.Domain.Entities.ApplicationStateHistory", b =>
                {
                    b.HasOne("Profiles.Domain.Entities.Application", "Application")
            ...
            modelBuilder.Entity("Profiles.Domain.Entities.DocumentVersion", b =>
                {
                    b.HasOne("Profiles.Domain.Entities.LegalDocument", "LegalDocument")
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("Profiles.Domain.Entities.Profile", b =>
                {
                    b.HasOne("Profiles.Domain.Entities.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("Profiles.Domain.Entities.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Profiles.Domain.Entities.RoleAssignment", b =>
                {
                    b.HasOne("Profiles.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
