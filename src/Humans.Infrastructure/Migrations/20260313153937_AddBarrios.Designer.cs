...
namespace Humans.Infrastructure.Migrations
{
    ...
    [Migration("20260313153937_AddBarrios")]
    partial class AddBarrios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Humans.Domain.Entities.Barrio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Domain.Entities.BarrioHistoricalName", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("barrio_historical_names", (string)null);
                });

            modelBuilder.Entity("Humans.Domain.Entities.BarrioImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("barrio_images", (string)null);
                });

            modelBuilder.Entity("Humans.Domain.Entities.BarrioLead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BarrioId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("IX_barrio_leads_active_unique")
                        .HasFilter("\"LeftAt\" IS NULL");

                    b.ToTable("barrio_leads", (string)null);
                });

            modelBuilder.Entity("Humans.Domain.Entities.BarrioSeason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BarrioId", "Year")
                        .IsUnique();

                    b.ToTable("barrio_seasons", (string)null);
                });

            modelBuilder.Entity("Humans.Domain.Entities.BarrioSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.PrimitiveCollection<string>("OpenSeasons")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("barrio_settings", (string)null);
            ...
            modelBuilder.Entity("Humans.Domain.Entities.BarrioHistoricalName", b =>
                {
                    b.HasOne("Humans.Domain.Entities.Barrio", "Barrio")
