...
The notice is shown only when the user would normally have manage rights (is a camp lead for this season) but the phase is closed. Non-leads never see the notice.
